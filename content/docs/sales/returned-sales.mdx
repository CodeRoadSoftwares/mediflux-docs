...
<Cards cols={2}>
  <Card
    title="Drug List"
    description="Verify returned stock was added back to inventory."
    href="/docs/inventory/drug-list"
    icon="Pill"
  />
  <Card
    title="Customer Ledger"
    description="Check if the refund affected the customer's outstanding balance."
    href="/docs/customers/ledger"
    icon="BookOpen"
  />
  <Card
    title="Add Credit Note"
    description="Formalize the return with a proper credit note for records."
    href="/docs/sales/add-credit-note"
    icon="FilePlus"
  />
  <Card
    title="Sales List"
    description="View the original sale and check its return status."
