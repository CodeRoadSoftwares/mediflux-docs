...
import * as __fd_glob_17 from "../content/docs/reports/profit-loss.mdx?collection=docs"
import * as __fd_glob_16 from "../content/docs/reports/index.mdx?collection=docs"
...
import { default as __fd_glob_4 } from "../content/docs/reports/meta.json?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "accounting/meta.json": __fd_glob_1, "api/meta.json": __fd_glob_2, "introduction/meta.json": __fd_glob_3, "reports/meta.json": __fd_glob_4, "purchases/meta.json": __fd_glob_5, "sales/meta.json": __fd_glob_6, }, {"how-to-write.mdx": __fd_glob_7, "accounting/index.mdx": __fd_glob_8, "accounting/ledgers.mdx": __fd_glob_9, "api/authentication.mdx": __fd_glob_10, "api/index.mdx": __fd_glob_11, "api/webhooks.mdx": __fd_glob_12, "introduction/getting-started.mdx": __fd_glob_13, "introduction/index.mdx": __fd_glob_14, "introduction/installation.mdx": __fd_glob_15, "reports/index.mdx": __fd_glob_16, "reports/profit-loss.mdx": __fd_glob_17, "purchases/create-purchase.mdx": __fd_glob_18, "purchases/index.mdx": __fd_glob_19, "sales/create-sale.mdx": __fd_glob_20, "sales/index.mdx": __fd_glob_21, "sales/returns.mdx": __fd_glob_22, });